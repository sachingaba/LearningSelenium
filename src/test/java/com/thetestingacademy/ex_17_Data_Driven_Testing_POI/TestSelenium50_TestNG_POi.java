...
public class TestSelenium50_TestNG_POi {
    ...
    public void verifyInvalidCredentials(String username ,String password){
        ...
        System.out.println("Multiple time I have to Check");
    ...
    public Object[][] getData(){
        return new Object[][]{
              new  Object[]{"iamsachin@gmail.com","intert"},
                      new  Object[]{"iamsac@gmail.com","intert"},
                      new  Object[]{"iamsach@gmail.com","intert"},
                      new  Object[]{"iamsacok@gmail.com","intert"},
